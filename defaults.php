...
class OC_Theme {
    ...
    public function __construct() {
        \OCP\Util::addScript('animu-theme', 'bundle');
    }
	...
	public function getSlogan() {
		return 'Almacenamiento de magonx, lolis, wallpapers y mucho mas';
	}
	...
	public function getLogoClaim() {
		return '<a href="https://storage.magonx.es">Magonx Storage</a>';
	}
	...
	public function getShortFooter() {
		...
		$footer = '© ' . $year . ' <a href="'.$this->getBaseUrl().'" target="_blank\">'.$this->getEntity().'</a>'.
			'<br/>' . $this->getSlogan();
